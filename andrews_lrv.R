...
#'
#'
#' @param e P by K vector of residual series, for which we recommend to use the recursive residuals from larger model.
#' @return  K by K vector of Long run variance using Andrews quadratic spectral kernel HAC.
